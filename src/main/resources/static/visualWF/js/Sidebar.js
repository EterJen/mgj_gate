...
function DOperation(name,description,preCondition,postLogic,preConditionFalseMessage)
{
	this.name = name;
	this.description = description;
...
Sidebar.prototype.addGeneralPalette = function(expand,elt)
{
	...
	var fns = [	 	
		...
		{
			var cell = new mxCell('节点名称', new mxGeometry(10, 10, 100, 100), 'Rectangle','html=1;whiteSpace=wrap;rounded=1;');
			cell.vertex = true;
	 	...
	 	this.createEdgeTemplateEntry('endArrow=classic;html=1;strokeColor=red', 50, 50, '', 'Directional Connector', null, lineTags + 'directional directed'),
	    this.createEdgeTemplateEntry('endArrow=classic;html=1;strokeColor=gray', 50, 50, '', '', null, lineTags + 'directional directed1'),
	    this.createEdgeTemplateEntry('endArrow=classic;html=1;strokeColor=blue', 50, 50, '', '', null, lineTags + 'directional directed2')
	];
...
Sidebar.prototype.createEdgeTemplate = function(style, width, height, value, title, showLabel, allowCellsInserted)
{
	...
	cell.data = new DOperation('操作名称','默认描述',true,null,null);
