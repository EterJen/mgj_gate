...
angular.module('pagination', []).directive('tmPagination',[function(){
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '<li class="ng-binding" ng-class="{disabled: conf.currentPage == 1}" ng-click="prevPage()"><span>&laquo;</span></li>' +
            '<li ng-repeat="item in pageList track by $index" ng-class="{active: item == conf.currentPage, separate: item == \'...\'}" ' +
            'ng-click="changeCurrentPage(item)">' +
            '<span>{{ item }}</span>' +
            '</li>' +
            '<li class="ng-binding" ng-class="{disabled: conf.currentPage == conf.numberOfPages}" ng-click="nextPage()"><span class="pagenation-last-child">&raquo;</span></li>' +
...
angular.module('paginationA', []).directive('tmPaginationA',[function(){
    return {
        restrict: 'EA',
        template: '<div style="margin-left: auto;margin-right:auto;margin-top: -8px" class="page-list center-block">' +
        '<ul class="pagination" ng-show="conf.totalItems > 0">' +
        '<li  class="ng-binding" ng-class="{disabled: conf.currentPage == 1}" ng-click="prevPage()"><span>&laquo;</span></li>' +
        '<li ng-repeat="item in pageList track by $index"  ng-class="{active: item == conf.currentPage, separate: item == \'...\'}" ' +
        'ng-click="changeCurrentPage(item)">' +
        '<span>{{ item }}</span>' +
        '</li>' +
        '<li class="ng-binding" ng-class="{disabled: conf.currentPage == conf.numberOfPages}" ng-click="nextPage()"><span>&raquo;</span></li>' +
        '</ul>' +
        '</div>',
        replace: true,
        scope: {
