...
// Unfortunately, due to scattered support, browser sniffing is required
    ...
    players.forEach(function (player) {
        ...
        var timeProgressBar = player.querySelector('.time-progress');
        ...
        video.addEventListener('timeupdate', function () {
            handleProgress(this, progressBar,timeProgressBar);
        });
    ...
    function handleProgress(video, progressBar,timeProgressBar) {
        var percent = video.currentTime / video.duration * 100;
        progressBar.style.flexBasis = percent + '%';
        timeProgressBar.innerHTML=formatSeconds(video.currentTime)+"/"+formatSeconds(video.duration);
    }
