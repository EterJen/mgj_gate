!function ($) {
    ...
    $.fn.autoMove = function (args) {
        ...
        that.moveFinish = false;

        that.bayMove = function () {
        ...
        that.bayStart = function () {
            that.css('visibility','visible');
            that.itvl = setInterval(function () {
                that.bayMove();
            }, 40);
        };
        that.bayClose = function () {
            that.moveFinish = true;
            that.bayStop();
            that.css('visibility','hidden');
        };

        that.bayStop = function () {
