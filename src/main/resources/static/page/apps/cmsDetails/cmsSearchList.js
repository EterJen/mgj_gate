...
myApp.controller('cmsSearchListCtrl', ['$rootScope', '$scope', 'ENV', '$state',  'SysUtils', '$timeout','$stateParams', function ($rootScope, $scope, ENV, $state, SysUtils, $timeout,$stateParams) {
    console.log("cmsSearchListCtrl");
    /*************************一、变量定义****************************/
    var title=$stateParams.parameterId;
    ...
    $scope.queryDetail = function () {
        var url='/twolevelcolumn/read/'+$scope.queryBean.twolevelcolumnId;
