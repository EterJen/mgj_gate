...
myApp.controller('wuguanjuCtrl', ['$scope', 'ENV', '$state', '$stateParams', 'SysUtils', function ($scope, ENV, $state, $stateParams, SysUtils) {
    ...
    $scope.fc.updateDocFullName = function () {
        /*拟稿日期*/
        $scope.task.theCommonFormInfo.formWuguanju.niGaoDate = [$scope.task.theCommonFormInfo.formWuguanju.niGaoY, $scope.task.theCommonFormInfo.formWuguanju.niGaoM, $scope.task.theCommonFormInfo.formWuguanju.niGaoD].join('-');
    };
