...
myApp.controller('formEditGenericofficePartyApprovedCtrl', ['$scope', 'ENV', '$state', '$stateParams',  'SysUtils', 'dataFactory', '$ocLazyLoad', function ($scope, ENV, $state, $stateParams,  SysUtils, dataFactory, $ocLazyLoad) {
    /*************************一、变量定义****************************/
    /*************************二、函数定义****************************/
     ...
     * 选择
     */
    $scope.fc.chooseRelateReceiveDocId = function (val){
    	$scope.task.theCommonFormInfo.belongProInst.relatedReceiveDocId = val +"（"+ $scope.task.theCommonFormInfo.docYear+"）";
