...
myApp.controller('formEditGenericJxwxinhanCtrl', ['$scope', 'ENV', '$state', '$stateParams',  'SysUtils', 'dataFactory', '$ocLazyLoad', function ($scope, ENV, $state, $stateParams,  SysUtils, dataFactory, $ocLazyLoad) {
    console.log("formEditGenericJxwxinhanCtrl controller");
