...
public class Attachment extends com.gwideal.core.common.CoreBaseEntity<Attachment, BigDecimal> {
    ...
    @IncAnnoColumn(name = "DESCRIPTION", dbType = "VARCHAR2", jdbcType = "VARCHAR", dataPrecision = "", dataScale = "0", dataLength = "250", comment = "默认标签")
    ...
    @IncAnnoColumn(name = "SIZE", dbType = "VARCHAR2", jdbcType = "VARCHAR", dataPrecision = "", dataScale = "0", dataLength = "16", comment = "默认标签")
